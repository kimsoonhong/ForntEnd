    ...
    <>
      ...
      <section id="work" className="section">
        ...
        <div className="work__projects">
          ...
          <div>
            <a
              href="https://github.com/kimsoonhong/recipe_project"
              className="project"
              target="blank"
            >
              <img
                src="/profile/about/recipe.png"
                alt="스크린샷 설명"
                className="project__img"
              />
              <div className="project__description">
      ...
      >
        <a
          style={{ display: "none" }}
          ref={recipe}
          href=" https://chartreuse-zydeco-fd9.notion.site/3a6a19b9ddeb4364a402eafd4c4a849f"
        ></a>
        dfs
      </a>
    </>
